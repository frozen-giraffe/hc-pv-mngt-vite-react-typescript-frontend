...
export class UtilsService {
     ...
     */
    public static updateImportMessage<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).post<UpdateImportMessageResponse, UpdateImportMessageError, ThrowOnError>({
            ...options,
            url: '/api/v1/utils/update-import-message'
        });
    }
